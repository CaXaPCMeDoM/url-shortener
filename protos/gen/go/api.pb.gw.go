...
func RegisterUrlShortenerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UrlShortenerServer) error {
	mux.Handle(http.MethodPost, pattern_UrlShortener_CreateShortURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/urlshortener.UrlShortener/CreateShortURL", runtime.WithHTTPPathPattern("/url-shorter"))
		if err != nil {
	...
	mux.Handle(http.MethodGet, pattern_UrlShortener_GetOriginalURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/urlshortener.UrlShortener/GetOriginalURL", runtime.WithHTTPPathPattern("/url-shorter/{alias}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterUrlShortenerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UrlShortenerClient) error {
	mux.Handle(http.MethodPost, pattern_UrlShortener_CreateShortURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/urlshortener.UrlShortener/CreateShortURL", runtime.WithHTTPPathPattern("/url-shorter"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodGet, pattern_UrlShortener_GetOriginalURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/urlshortener.UrlShortener/GetOriginalURL", runtime.WithHTTPPathPattern("/url-shorter/{alias}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UrlShortener_CreateShortURL_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"url-shorter"}, ""))
	pattern_UrlShortener_GetOriginalURL_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"url-shorter", "alias"}, ""))
)
